...
{
    public abstract class ListTableManagerCore<TListElement, TElementData> : NonsensicalUI
        where TListElement : MonoBehaviour
        where TElementData : class
    {
        ...
        public virtual bool Delete(TListElement deleteElement)
        {
        ...
        public virtual bool Delete(int index)
        {
            ...
            else
            {
                ...
                {
                    SetValue(Elements[i], ElementData[i], i);
                }
        ...
        protected virtual void UpdateUI()
        {
            ...
            for (int i = 0; i < dataCount; i++)
            {
                ...
                SetValue(crtElement, ElementData[i], i);
            }

            //隐藏剩余未使用的子物体
            for (int i = dataCount; i < Elements.Count; i++)
            {
        ...
        protected abstract void SetValue(TListElement element, TElementData elementData, int index);
