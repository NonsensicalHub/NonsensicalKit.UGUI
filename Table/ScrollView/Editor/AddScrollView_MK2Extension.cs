...
{
    public class AddScrollView_MK2Extension
    {
        ...
        [MenuItem("GameObject/Nonsensical/UI/ScrollView_MK2", false, 90)]
        public static void AddScrollView(MenuCommand menuCommand)
        {
            InternalAddScrollView<ScrollView_MK2>(menuCommand);
        }

        protected static void InternalAddScrollView<T>(MenuCommand menuCommand) where T : ScrollView_MK2
        {
            ...
            ScrollView_MK2 scrollRect = root.AddComponent<T>();
